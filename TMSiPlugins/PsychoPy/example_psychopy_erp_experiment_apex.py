...
try:
    ...
    if (len(discoveryList) > 0):
        ...
        experiment = PsychopyExperimentSetup(TMSiDevice="APEX", COM_port = 'COM5', n_trials = n_trials, target_value = 16, nontarget_value= 2,
        ...
        dev.start_measurement(MeasurementType.APEX_SIGNAL)       
