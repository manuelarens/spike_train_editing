...
/**
 * @file ${poly5_file_force_writer.py} 
 * @brief Poly5 File + Force profile Writer
 *
 */
...
class Poly5Writer:
    ...
    def open(self, device, channel_names, channel_unit_names):
        """
        Receives channel names and units from the ForceFeedbackPlotterHelper as arguments
        The rest is the same as normal poly5writer
        """
        self.device = device
        self.channel_names = channel_names
        self.channel_unit_names = channel_unit_names
        try:
            ...
            print('Initialize force file writer')
            ...
            # Write poly5-header for tmsi measurement
            ...
            for i in range(len(self.channel_names)):
                Poly5Writer._writeSignalDescription(self._fp, i, self.channel_names[i], self.channel_unit_names[i])
