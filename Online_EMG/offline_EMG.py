...
class EMG_Decomposition():
    def __init__(self, rejected_chan = []):
    ...
    def run(self, grid_name = '4-8-L', filepath= r'tmsi-python-interface/measurements/Training_measurement+ForceProfile-20240417_085837.poly5'):
        ################## FILE ORGANISATION ################################

        self.emg_obj.select_file(filepath= filepath) #select the training file (.mat), composed by ISpin 
        ...
        ##################### POSTPROCESSING #################################
                ...
                self.emg_obj.post_process_EMG_for_biofeedback(g, tracker) # g and tracker are unncessary! remove  
        ...
        self.emg_obj.save_EMG_decomposition_for_biofeedback(g,tracker, interval) #g and tracker are unused 
        print('Data saved')
